...
//    ******************************  All Update  ********************************************8
    ...
    public boolean updateDriverName(String original,String latest,String oldcontact,String newcontact,String rname)
    {
        ...
        try{
            ...
            String hql = "update RouteInfo set dname= :lr_name where dname= :r_name and routename= :r_name";
    ...
    public boolean updateDriverContact(String original,String latest,String rname)
    {
        ...
        try{
            ...
            String hql = "update RouteInfo set dcontact= :lr_name where dcontact= :r_name and routename= :r_name";
